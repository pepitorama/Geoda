  ...
  const STRINGS = {
    es: {
      ...
      helpBody: [
        ...
        "<kbd>Enter</kbd> lanzar oleada &nbsp; <kbd>P</kbd>/<kbd>Esc</kbd> pausa &nbsp; <kbd>M</kbd> silencio &nbsp; <kbd>+</kbd>/<kbd>-</kbd> volumen &nbsp; <kbd>H</kbd> esta ayuda",
        "<h3>Profundidad</h3>",
    ...
    en: {
      ...
      helpBody: [
        ...
        "<kbd>Enter</kbd> launch wave &nbsp; <kbd>P</kbd>/<kbd>Esc</kbd> pause &nbsp; <kbd>M</kbd> mute &nbsp; <kbd>+</kbd>/<kbd>-</kbd> volume &nbsp; <kbd>H</kbd> this help",
        "<h3>Depth</h3>",
